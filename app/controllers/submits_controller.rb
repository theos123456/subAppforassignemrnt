class SubmitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @submit.save
        format.html { redirect_to root_path, notice: 'Submit was successfully created.' }
  ...
  def destroy
    @submit.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Submit was successfully destroyed.' }
  ...
  private
    ...
    def submit_params
      params.require(:submit).permit(:link, :user_id, :assignment_id)
    end
end
