...
class SubmitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submit" do
    assert_difference('Submit.count') do
      post submits_url, params: { submit: { assignment_id: @submit.assignment_id, link: @submit.link, user_id: @submit.user_id } }
    end
  ...
  test "should update submit" do
    patch submit_url(@submit), params: { submit: { assignment_id: @submit.assignment_id, link: @submit.link, user_id: @submit.user_id } }
